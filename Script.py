...
<b>● 𝘏𝘰𝘴𝘵 𝘚𝘦𝘳𝘷𝘦𝘳: 🚀</b>
<b>● 𝘝𝘦𝘳𝘴𝘪𝘰𝘯: 𝘔𝘢𝘹</b>
<b>● 𝘔𝘢𝘪𝘯 𝘎𝘳𝘰𝘶𝘱: <a href=https://t.me/newgen_cinemaazzz>NewGen Cinemaazzz™</a></b>
<b>● 𝘕𝘦𝘸 𝘔𝘰𝘷𝘪𝘦𝘴: <a href=https://t.me/Team_NGC>𝘕𝘦𝘸 𝘔𝘰𝘷𝘪𝘦𝘴</a></b>"""
    SOURCE_TXT = """<b>NOTE:</b>
- 𝘕𝘎𝘊 𝘪𝘔𝘥𝘉 𝘣𝘰𝘵𝘴 𝘢𝘳𝘦 𝘵𝘳𝘶𝘦𝘭𝘺 𝘓𝘰𝘤𝘬𝘦𝘥 𝘗𝘳𝘰𝘫𝘦𝘤𝘵𝘴.. 
- Source code🤭 - https://t.me/Unavailable4allTime

<b>𝘋𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳:</b>
- <a href=https://t.me/Unavailable4allTime>𝘈𝘴𝘩𝘪𝘬 𝘔𝘩𝘥</a></b>"""
    MANUELFILTER_TXT = """Help: <b>Filters</b>

- Filter is the feature were users can set automated replies for a particular keyword and EvaMaria will respond whenever a keyword is found the message

<b>NOTE:</b>
1. ɴɢᴄ⇢ᖴɪʟᴛᴇʀ⎝ᴜᒪᴛʀᴀ⎞ should have admin privillage.
...
- ɴɢᴄ⇢ᖴɪʟᴛᴇʀ⎝ᴜᒪᴛʀᴀ⎞ Supports both url and alert inline buttons.

<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. ɴɢᴄ⇢ᖴɪʟᴛᴇʀ⎝ᴜᒪᴛʀᴀ⎞ supports buttons with any telegram media type.
3. Buttons should be properly parsed as markdown format

<b>URL buttons:</b>
<code>[Button Text](https://t.me/Unavailable4allTime)</code>
